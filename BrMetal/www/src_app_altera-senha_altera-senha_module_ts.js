...
let AlteraSenhaPage = class AlteraSenhaPage {
  ...
  email;
  tipo;
  constructor(svc, db, navCtr, activatedRoute) {
    this.svc = svc;
    this.db = db;
    this.navCtr = navCtr;
  ...
  ngOnInit() {
    ...
    if (this.tipo == 'exclui') this.db.excluiUsuario();
    this.db.autenticado();
  }
  alteraSenha(form) {
...
AlteraSenhaPage = (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_7__.Component)({
