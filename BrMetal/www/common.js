...
/***/ 3604:
/*!*************************************************!*\
  !*** ./src/app/modal-valor/modal-valor.page.ts ***!
  \*************************************************/
...
/* harmony export */   ModalValorPage: () => (/* binding */ ModalValorPage)
/* harmony export */ });
...
/* harmony import */ var _modal_valor_page_html_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modal-valor.page.html?ngResource */ 4792);
/* harmony import */ var _modal_valor_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modal-valor.page.scss?ngResource */ 3396);
/* harmony import */ var _modal_valor_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_modal_valor_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_2__);
...
let ModalValorPage = class ModalValorPage {
  static {
    ModalValorPage_1 = this;
  }
  mc;
  gen;
  titulo;
  ...
  modalValor(titulo, valorOrig, disponivel) {
    var _this = this;
  ...
  okClick() {
    if (this.disponivel && this.disponivel < this.valor) this.invalido = true;else this.invalido = false;
    if (!this.invalido) this.mc.dismiss(this.valor);
  }
...
ModalValorPage = ModalValorPage_1 = (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_5__.Component)({
  selector: 'app-modal-valor',
  template: _modal_valor_page_html_ngResource__WEBPACK_IMPORTED_MODULE_1__,
  styles: [(_modal_valor_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_2___default())]
})], ModalValorPage);
...
/***/ 3295:
/*!*********************************************************************!*\
  !*** ./src/app/pages/listaCadastro/listaCadastro-routing.module.ts ***!
  \*********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   listaCadastroPageRoutingModule: () => (/* binding */ listaCadastroPageRoutingModule)
/* harmony export */ });
...
/* harmony import */ var _listaCadastro_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./listaCadastro.page */ 1281);
...
const routes = [{
  path: '',
  component: _listaCadastro_page__WEBPACK_IMPORTED_MODULE_0__.listaCadastroPage
}];
let listaCadastroPageRoutingModule = class listaCadastroPageRoutingModule {};
listaCadastroPageRoutingModule = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
...
const attachComponent = /*#__PURE__*/function () {
  var _ref = (0,_Users_rodrigo_Desktop_Ionic_BrMetal_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (delegate, container, component, cssClasses, componentProps, inline) {
    var _a;
    if (delegate) {
...
const CoreDelegate = () => {
  ...
  const attachViewToDom = /*#__PURE__*/function () {
    var _ref2 = (0,_Users_rodrigo_Desktop_Ionic_BrMetal_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (parentElement, userComponent, userComponentProps = {}, cssClasses = []) {
      var _a, _b;
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,_Users_rodrigo_Desktop_Ionic_BrMetal_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
      yield new Promise(resolve => (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_1__.c)(el, resolve));
...
/***/ 3396:
/*!**************************************************************!*\
  !*** ./src/app/modal-valor/modal-valor.page.scss?ngResource ***!
  \**************************************************************/
...
ion-input {
  ...
  align-items: center;
  text-align: center;
}`, "",{"version":3,"sources":["webpack://./src/app/modal-valor/modal-valor.page.scss"],"names":[],"mappings":"AAAA;EACI,YAAA;EACA,gBAAA;AACJ;;AACA;EACI,eAAA;EACA,mBAAA;EACA,kBAAA;AAEJ","sourcesContent":["ion-button {\n    margin: auto;\n    min-width: 100px;\n}\nion-input{\n    font-size: 300%;\n    align-items: center;\n    text-align: center;\n\n}"],"sourceRoot":""}]);
// Exports
...
/***/ 4792:
/*!**************************************************************!*\
  !*** ./src/app/modal-valor/modal-valor.page.html?ngResource ***!
  \**************************************************************/
/***/ ((module) => {

"use strict";
module.exports = "<ion-header>\n  <ion-toolbar>\n    <ion-title>{{titulo}}:  {{this.gen.formataCampoSaida(this.disponivel?this.disponivel:' ','number',0)}}</ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content class=\"ion-align-items-center\">\n<ion-input #input  size='large' type=\"number\" [placeholder]=\"this.valorOrig\" [(ngModel)]=\"valor\" ></ion-input>\n\n</ion-content>\n<ion-footer>\n  <span *ngIf=\"this.valor>this.disponivel\" style=\"color: red\">Quantidade acima do Estoque Disponivel</span>\n  <ion-toolbar>\n    <ion-buttons>\n      <ion-button size=\"large\" color=\"primary\"(click)=\"this.mc.dismiss()\">\n        Cancelar\n     </ion-button>\n      <ion-button id=\"submit\" size=\"large\" color=\"primary\" (click)=\"okClick()\">\n         OK\n      </ion-button>\n    </ion-buttons>\n      </ion-toolbar>\n</ion-footer>\n";
