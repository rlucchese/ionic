...
const Toggle = class {
  constructor(hostRef) {
     ...
     */
    this.required = false;
    this.setupGesture = /*#__PURE__*/(0,_Users_rodrigo_Desktop_Ionic_Apponta_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const {
        toggleTrack
      } = _this;
      if (toggleTrack) {
